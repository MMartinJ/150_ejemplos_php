...
$path = 'imag'; # Directorio donde están las imágenes
$limit = 3; # Cuantas imágenes se mostraran por pagina
...
if (is_dir($path)){
 $dir = opendir($path);
 # Recorremos los ficheros que hay en el directorio y cojemos solamente aquellos cuya estensión
...
<?php echo "Hay un total de $total fotos y $paginas paginas" ?>
