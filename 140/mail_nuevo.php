...
try {
    ...
    $mail->setFrom('prueba@ejemplo.com', 'Servidor Local');
    $mail->addAddress('destinatario@ejemplo.com', 'Destinatario de prueba');

    // Contenido
    $mail->isHTML(true);
    $mail->Subject = 'Correo de prueba con Papercut';
    $mail->Body    = '<h1>Hola</h1><p>Este es un mensaje de prueba enviado a Papercut SMTP.</p>';
